...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for mask.
GH_REPO="https://github.com/jakedeichert/mask"
TOOL_NAME="mask"
TOOL_TEST="mask --help"
...
# NOTE: You might want to remove this if mask is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if mask has other means of determining installable versions.
  list_github_tags
}
...
install_version() {
  ...
  (
    ...
    # TODO: Asert mask executable exists.
    local tool_cmd
