...
GH_REPO="https://github.com/opsgenie/opsgenie-lamp"
TOOL_NAME="opsgenie-lamp"
TOOL_TEST="opsgenie-lamp --version"
...
download_release() {
  ...
  url="$GH_REPO/releases/download/v${version}/opsgenie-lamp_${version}_${platform}_${arch}.zip"
